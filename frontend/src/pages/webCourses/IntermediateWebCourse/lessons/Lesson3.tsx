            ...
            <div className='aboutBeginnerWeb'>
                ...
                <div className='beginnerPictureContainer' style={{ marginBottom: '3em' }}>
                    <div
                        ...
                        onClick={() => window.open(`/showCase/1/lesson/3/course/${courseId}`, '_blank')}
                    ...
                    <div
                        className="imageWithDescription"
                        onClick={() => window.open(`/showCase/2/lesson/3/course/${courseId}`, '_blank')}
                        style={{ cursor: 'pointer' }}
                    >
                    ...
                    <div
                        className="imageWithDescription"
                        onClick={() => window.open(`/showCase/3/lesson/3/course/${courseId}`, '_blank')}
                        style={{ cursor: 'pointer' }}
                    >
                    ...
                    <div
                        className="imageWithDescription"
                        onClick={() => window.open(`/showCase/4/lesson/3/course/${courseId}`, '_blank')}
                        style={{ cursor: 'pointer' }}
                    >
