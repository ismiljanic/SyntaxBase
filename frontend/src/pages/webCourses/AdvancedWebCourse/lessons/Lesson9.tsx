            ...
            <div className='aboutBeginnerWeb'>
                <div className="aboutCourseDiv2" style={{ paddingBottom: '7em' }}>
                    ...
                    <div className="descriptionOfCourse">
                        Every system must start with a strong foundation. In this stage, you’ll implement essential user-facing features that form the backbone of the application.
                ...
                <div className="aboutCourseDiv2" style={{ paddingBottom: '7em' }}>
                    ...
                    <div className="descriptionOfCourse">
                        By the end of this lesson, you will have a functioning system that allows donor registration, secure authentication, scheduling of appointments, and tracking of donation history — the essential building blocks of your final project.
                    </div>
